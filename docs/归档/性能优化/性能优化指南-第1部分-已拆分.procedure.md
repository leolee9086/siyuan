...
> 
> - **归档时间**：2026-01-26
> - **归档原因**：本文档不符合规程"简短专注、避免冗杂、不超过300行"的要求，已拆分为3个专注的文档
> - **新文档**：
>   * 规程文档：[性能优化工程规程](../规程/性能优化/性能优化.procedure.md)
>   * 技术指南：[性能优化技术指南](../技术指南/性能优化技术指南.md)
>   * 最佳实践：[性能优化最佳实践](../最佳实践/性能优化最佳实践.md)
> - **建议**：请使用上述新文档，本文档仅作归档参考

 ...
 * ```
 */
export declare function 匹配<T>(模式: Type<T>, 输入: unknown): T | null;
/**
 * 判断模式A是否是模式B的子集
 * 即：A的所有可能值都是B的可能值
 *
 ...
 * ```
 */
export declare function 是子集(a: Type, b: Type): boolean;
/**
 * 判断两个模式是否有交集
 * 即：存在某个值同时满足两个模式
 *
 ...
 * ```
 */
export declare function 有交集(a: Type, b: Type): boolean;
/**
 * 检查模式是否为空集（never）
 *
 * @param 模式 - 待检查的模式
 * @returns 是空集返回true
 */
export declare function 是空集(模式: Type): boolean;

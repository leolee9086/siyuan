...
func testModel(c *gin.Context) {
	...
	available, matched, err := util.TestModel(provider.APIKey, provider.BaseURL, provider.Protocol, modelName,
		provider.RequestTimeout, model.Conf.AI.EffectiveAPIProxy(model.Conf.System))

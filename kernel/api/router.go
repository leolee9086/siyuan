...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/system/detectSystemProxy", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, detectSystemProxy)
	...
	ginServer.Handle("POST", "/api/notebook/getWorkspaceAIMainNotebookState", model.CheckAuth, getWorkspaceAIMainNotebookState)
	ginServer.Handle("POST", "/api/notebook/createWorkspaceAIMainNotebook", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, createWorkspaceAIMainNotebook)
	ginServer.Handle("POST", "/api/notebook/resolveWorkspaceAIMainNotebookConflict", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, resolveWorkspaceAIMainNotebookConflict)
	...
	ginServer.Handle("POST", "/api/bazaar/getBazaarKeywords", model.CheckAuth, getBazaarKeywords)
	...
	ginServer.Handle("POST", "/api/ai/agent/steer", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, agentSteer)
	ginServer.Handle("POST", "/api/ai/agent/turn", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, agentTurn)
	ginServer.Handle("POST", "/api/ai/agent/queue", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, agentQueue)
	ginServer.Handle("GET", "/api/ai/agent/queue", model.CheckAuth, model.CheckAdminRole, getAgentQueue)
	ginServer.Handle("POST", "/api/ai/agent/queue/update", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, updateAgentQueue)
	ginServer.Handle("POST", "/api/ai/agent/queue/cancel", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, cancelAgentQueue)
	ginServer.Handle("POST", "/api/ai/agent/queue/promote", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, promoteAgentQueue)
	ginServer.Handle("POST", "/api/ai/agent/interrupt", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, interruptAgentTurn)
	ginServer.Handle("GET", "/api/ai/agent/events", model.CheckAuth, model.CheckAdminRole, agentEvents)
	...
	ginServer.Handle("POST", "/api/ai/agent/createPromptSourceDocument", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, createAgentPromptSourceDocument)
	...
	ginServer.Handle("POST", "/api/vector/collections/delete", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, vectorDeleteCollection)
	ginServer.Handle("POST", "/api/vector/add", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, vectorAdd)
	ginServer.Handle("POST", "/api/vector/delete", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, vectorDelete)
	ginServer.Handle("POST", "/api/vector/query", model.CheckAuth, vectorQuery)
	ginServer.Handle("POST", "/api/vector/keys", model.CheckAuth, vectorKeys)
	ginServer.Handle("POST", "/api/vector/state", model.CheckAuth, vectorState)
	ginServer.Handle("POST", "/api/vector/rebuild", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, vectorRebuild)
	...
	ginServer.Handle("POST", "/api/embedding/blocks/pushWithVectors", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, embeddingBlocksPushWithVectors)
	ginServer.Handle("POST", "/api/embedding/blocks/query", model.CheckAuth, embeddingBlocksQuery)
	ginServer.Handle("POST", "/api/embedding/blocks/queryWithVector", model.CheckAuth, embeddingBlocksQueryWithVector)
	ginServer.Handle("POST", "/api/embedding/blocks/pending", model.CheckAuth, embeddingBlocksPending)
	ginServer.Handle("POST", "/api/embedding/blocks/embedded", model.CheckAuth, embeddingBlocksEmbedded)
	ginServer.Handle("POST", "/api/embedding/assets/push", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, embeddingAssetsPush)
	ginServer.Handle("POST", "/api/embedding/assets/pushWithVectors", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, embeddingAssetsPushWithVectors)
	ginServer.Handle("POST", "/api/embedding/assets/query", model.CheckAuth, embeddingAssetsQuery)
	ginServer.Handle("POST", "/api/embedding/assets/pending", model.CheckAuth, embeddingAssetsPending)
	ginServer.Handle("POST", "/api/embedding/collections/delete", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, embeddingCollectionsDelete)
	// 模型管理
	...
	ginServer.Handle("POST", "/api/s-forge/file-browser/editor/read", model.CheckAuth, model.CheckAdminRole, readSForgeFileBrowserEditor)
	ginServer.Handle("POST", "/api/s-forge/file-browser/editor/write", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, writeSForgeFileBrowserEditor)
	ginServer.Handle("POST", "/api/s-forge/file-browser/search", model.CheckAuth, model.CheckAdminRole, searchSForgeFileBrowserAssets)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider-search", model.CheckAuth, model.CheckAdminRole, searchSForgeFileBrowserProvider)
	ginServer.Handle("POST", "/api/s-forge/file-browser/providers", model.CheckAuth, model.CheckAdminRole, listFileBrowserProviderDescriptors)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/session/open", model.CheckAuth, model.CheckAdminRole, openFileBrowserProviderSession)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/session/close", model.CheckAuth, model.CheckAdminRole, closeFileBrowserProviderSession)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/resources", model.CheckAuth, model.CheckAdminRole, listFileBrowserProviderResources)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/list", model.CheckAuth, model.CheckAdminRole, listFileBrowserProviderDirectory)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/stat", model.CheckAuth, model.CheckAdminRole, statFileBrowserProviderEntry)
	ginServer.Handle("GET", "/api/s-forge/file-browser/provider/content", model.CheckAuth, model.CheckAdminRole, serveFileBrowserProviderContent)
	ginServer.Handle("GET", "/api/s-forge/file-browser/provider/operation", model.CheckAuth, model.CheckAdminRole, getFileBrowserProviderOperation)
	ginServer.Handle("GET", "/api/s-forge/file-browser/provider/health", model.CheckAuth, model.CheckAdminRole, probeFileBrowserProvider)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/create-directory", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, createFileBrowserProviderDirectory)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/create-file", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, createFileBrowserProviderFile)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/update", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, updateFileBrowserProviderEntry)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/update-content", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, updateFileBrowserProviderContent)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/delete", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, deleteFileBrowserProviderEntries)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/copy", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, copyFileBrowserProviderEntry)
	ginServer.Handle("POST", "/api/s-forge/file-browser/provider/operations/move", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, moveFileBrowserProviderEntry)
	...
	ginServer.Handle("POST", "/api/s-forge/bazaar/getPublishWorkspace", model.CheckAuth, model.CheckAdminRole, getBazaarPublishWorkspace)
	ginServer.Handle("POST", "/api/s-forge/bazaar/setPublishConfig", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setBazaarPublishConfig)
	ginServer.Handle("POST", "/api/s-forge/bazaar/upsertSource", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, upsertBazaarSource)
	ginServer.Handle("POST", "/api/s-forge/bazaar/removeSource", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, removeBazaarSource)
	ginServer.Handle("POST", "/api/s-forge/bazaar/testSource", model.CheckAuth, model.CheckAdminRole, testBazaarSource)
	ginServer.Handle("POST", "/api/s-forge/bazaar/getSourcePackages", model.CheckAuth, model.CheckAdminRole, getBazaarSourcePackages)
	ginServer.Handle("POST", "/api/s-forge/bazaar/publishPackage", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, publishBazaarPackage)
	ginServer.Handle("POST", "/api/s-forge/bazaar/installPackageFromSource", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, installBazaarPackageFromSource)
	ginServer.Handle("POST", "/api/s-forge/bazaar/securityStats", model.CheckAuth, model.CheckAdminRole, getBazaarSecurityStats)
	ginServer.Handle("POST", "/api/s-forge/bazaar/public/auth", checkBazaarRateLimit, loginBazaarPublicAuth)
	ginServer.Handle("POST", "/api/s-forge/bazaar/public/logout", checkBazaarRateLimit, logoutBazaarPublicAuth)
	ginServer.Handle("GET", "/api/s-forge/bazaar/public/index", checkBazaarRateLimit, checkBazaarPublicAuth, getBazaarPublicIndex)
	ginServer.Handle("GET", "/api/s-forge/bazaar/public/source", checkBazaarRateLimit, getBazaarPublicSourcePage)
	ginServer.Handle("GET", "/api/s-forge/bazaar/public/source/*filepath", checkBazaarRateLimit, getBazaarPublicSourcePage)
	ginServer.Handle("GET", "/api/s-forge/bazaar/public/download/:artifactID", checkBazaarRateLimit, checkBazaarPublicAuth, downloadBazaarPublicPackage)
}

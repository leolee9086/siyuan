export class  kernelApiList{
	...
	this.set("POST", "/api/filetree/getIDsByHPath",  "getIDsByHPath")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/filetree/upsertIndexes",   "upsertIndexes")//仅生成函数,尚未定义
	this.set("POST", "/api/filetree/removeIndexes",   "removeIndexes")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/format/netAssets2LocalAssets",   "netAssets2LocalAssets")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/sqlite/flushTransaction",   "flushTransaction")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/search/getEmbedBlock",  "getEmbedBlock")//仅生成函数,尚未定义
	this.set("POST", "/api/search/updateEmbedBlock",  "updateEmbedBlock")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/search/listInvalidBlockRefs",  "listInvalidBlockRefs")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/getTailChildBlocks",  "getTailChildBlocks")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/getDOMText",  "getDOMText")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/appendDailyNoteBlock",   "appendDailyNoteBlock")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/foldBlock",   "foldBlock")//仅生成函数,尚未定义
	this.set("POST", "/api/block/unfoldBlock",   "unfoldBlock")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/block/getParentNextChildID",  "getParentNextChildID")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/attr/batchSetBlockAttrs",   "batchSetBlockAttrs")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/sync/exportSyncProviderS3",  "exportSyncProviderS3")//仅生成函数,尚未定义
	this.set("POST", "/api/sync/importSyncProviderS3",   "importSyncProviderS3")//仅生成函数,尚未定义
	this.set("POST", "/api/sync/exportSyncProviderWebDAV",  "exportSyncProviderWebDAV")//仅生成函数,尚未定义
	this.set("POST", "/api/sync/importSyncProviderWebDAV",   "importSyncProviderWebDAV")//仅生成函数,尚未定义
	...
	this.set("POST", "/api/av/addAttributeViewKey",   "addAttributeViewCol")//仅生成函数,尚未定义
	this.set("POST", "/api/av/removeAttributeViewKey",   "removeAttributeViewCol")//仅生成函数,尚未定义
	this.set("POST", "/api/av/sortAttributeViewKey",   "sortAttributeViewCol")//仅生成函数,尚未定义
	this.set("POST", "/api/av/addAttributeViewValues",   "addAttributeViewValues")//仅生成函数,尚未定义
	this.set("POST", "/api/av/removeAttributeViewValues",   "removeAttributeViewValues")//仅生成函数,尚未定义

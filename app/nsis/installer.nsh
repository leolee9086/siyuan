...
Function AppendInstallLog
    ...
    ClearErrors
    FileOpen $7 "$TEMP\S-Forge-install.log" a
...
!macro customUnInstall
    ${IfNot} ${isUpdated}
        IfFileExists "$PROFILE\.config\siyuan-forge\*.*" 0 skipConfigDelete
    ...
    ${IfNot} ${isUpdated}
        IfFileExists "$PROFILE\SiYuan-Forge\*.*" 0 skipWorkspaceDelete

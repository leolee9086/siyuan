    ...
    private render() {
      ...
      <div id="sidebarContainer">
        <div id="toolbarSidebar">
          <div id="toolbarSidebarLeft">
              <button id="viewThumbnail" class="toolbarButton toggled b3-tooltips b3-tooltips__ne" aria-label="${siyuanI18n.thumbsTitle}">
                <svg><use xlink:href="#iconImage"></use></svg>
              </button>
              <button id="viewOutline" class="toolbarButton b3-tooltips b3-tooltips__ne" aria-label="${siyuanI18n.outline}">
          ...
          <div id="toolbarSidebarRight">
            <div id="outlineOptionsContainer" class="fn__hidden">
              <button id="currentOutlineItem" class="toolbarButton b3-tooltips b3-tooltips__nw" disabled="disabled" aria-label="${siyuanI18n.focusOutline}">
      ...
      <div id="mainContainer">
        <div class="findbar b3-menu fn__hidden doorHanger" id="findbar">
            ...
            <button id="findPreviousButton" class="toolbarButton findPrevious b3-tooltips b3-tooltips__n" aria-label="${siyuanI18n.previous}">
                <svg><use xlink:href="#iconUp"></use></svg>
            </button>
            <button id="findNextButton" class="toolbarButton findNext b3-tooltips b3-tooltips__n" aria-label="${siyuanI18n.next}">
        ...
        <div class="pdf__toolbar">
          <div id="toolbarContainer">
            <div id="toolbarViewer">
                <button id="sidebarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="sidebarContainer" aria-label="${siyuanI18n.toggleSidebarNotification2Title} ${updateHotkeyTip("F4")}">
                    <svg><use xlink:href="#iconLayoutRight"></use></svg>
                </button>
                <button id="viewFindButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${siyuanI18n.search} ${updateHotkeyTip("⌘F")}">
                  <svg><use xlink:href="#iconSearch"></use></svg>
                </button>
                <button id="rectAnno" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${siyuanI18n.rectAnnotation} ${updateHotkeyTip("⌘D")}/${updateHotkeyTip("⌥D")}">
                ...
                <span id="scaleSelectContainer" class="dropdownToolbarButton">
                  <select id="scaleSelect" class="b3-select">
                    <option id="pageAutoOption" value="auto" selected="selected">${siyuanI18n.pageScaleAuto}</option>
                ...
                <button id="secondaryToolbarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__sw" aria-label="${siyuanI18n.more}" aria-expanded="false" aria-controls="secondaryToolbar">
      ...
      <div id="dialogContainer">
        ...
        <div class="dialog" id="documentPropertiesDialog">
            <div class="row">
              <span>${siyuanI18n.fileName}</span> <p id="fileNameField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.fileSize}</span> <p id="fileSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${siyuanI18n.title1}</span> <p id="titleField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.author}</span> <p id="authorField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.subject}</span> <p id="subjectField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.keywords}</span> <p id="keywordsField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.creationDate}</span> <p id="creationDateField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.modificationDate}</span> <p id="modificationDateField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.creator}</span> <p id="creatorField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>PDF ${siyuanI18n.producer}</span> <p id="producerField">-</p>
            </div>
            <div class="row">
              <span>PDF ${siyuanI18n.version}</span> <p id="versionField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.pageCount}</span> <p id="pageCountField">-</p>
            </div>
            <div class="row">
              <span>${siyuanI18n.pageSize}</span> <p id="pageSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${siyuanI18n.linearized}</span> <p id="linearizedField">-</p>
            </div>
            <div class="buttonRow">

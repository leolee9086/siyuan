export function horizontalScrollFirst(event: WheelEvent) {
...
export function verticalScrollFirst(event: WheelEvent) {
    const container = event.currentTarget as HTMLElement;
...
export function verticalScroll(event: WheelEvent) {
    const container = event.currentTarget as HTMLElement;
...
export function horizontalScroll(event: WheelEvent) {

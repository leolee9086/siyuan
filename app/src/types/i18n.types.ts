...
apiProvider: `API 提供商`
apiProviderTip: `选择后将使用该提供商的 API 服务实现 AI 相关功能（ChatGPT、Claude、DeepSeek 等系列模型均支持 OpenAI 接口）`
skip: `跳过`
nextRound: `下一轮`
save: `保存`
ai: `人工智能`
...
kernelFault1: `你的数据应该是安全的，请检查网络连接和内核进程是否正常，然后重新启动思源笔记`
...
_kernel: {
  ...
  '27': `正在上传 [%v]`
  '28': `网络异常，请稍后再试`
  '29': `该功能需要购买 <a target='_blank' href='\$\{accountServer\}/subscribe/siyuan'>[年付订阅]</a> 后才能使用（如果你已经购买，请在 设置 - 账号中刷新或者重新登录）`
  '30': `获取云端信息失败`
  '31': `账号鉴权失败，请重新登录账号`
  '32': `删除云端笔记本失败`

...
/** 执行标签序号切换命令。 */
const executeTabIndexDesktopGlobalCommand = ({ command }: GlobalCommandContext) => {
...
/** 执行按最近编辑顺序切换标签命令。 */
const executeGoToEditTabDesktopGlobalCommand = ({ command }: GlobalCommandContext) => {
 ...
 */
export const executeDesktopTabGlobalCommand = (context: GlobalCommandContext) => {

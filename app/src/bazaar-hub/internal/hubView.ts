...
/** @同步豁免: UI构建 */
export const readStringField = (data: unknown, key: string): string => {
...
/** @同步豁免: UI构建 */
export const readSourceIDFromEvent = (event: Event): string => {
...
/** @同步豁免: UI构建 */
export const readSourceIDFromHubEvent = (event: Event): string => {
...
/** @同步豁免: UI构建 */
export const findSourceByID = (bundle: IBazaarWorkspaceBundle | null, sourceID: string): Config.IBazaarSource | null => {
    if (!bundle) {
        return null;
    }
...
/** @同步豁免: UI构建 */
export const pickDefaultSource = (bundle: IBazaarWorkspaceBundle, preferredSourceID: string): string => {
...
/** @同步豁免: UI构建 */
export const renderHubLayout = (container: HTMLElement): void => {
...
/** @同步豁免: UI构建 */
export const queryRequiredElement = (container: HTMLElement, selector: string): HTMLElement => {
...
/** @同步豁免: UI构建 */
export const querySearchInput = (container: HTMLElement): HTMLInputElement | null => {
...
export const renderSummary = (state: {
    ...
    sourceID: string;
}, summaryElement: HTMLElement): void => {
    if (!state.bundle) {
...
export const renderSourceList = (state: {
    bundle: IBazaarWorkspaceBundle | null;
    sourceID: string;
}, sourceListElement: HTMLElement): void => {
    if (!state.bundle) {
...
/** @同步豁免: UI构建 */
export const setPackageMessage = (packageListElement: HTMLElement, message: string): void => {
...
const createPackageActions = (pkg: IBazaarPublishedItem, source: Config.IBazaarSource): HTMLDivElement => {
    const actions = document.createElement("div");
...
const createPackageCard = (pkg: IBazaarPublishedItem, source: Config.IBazaarSource): HTMLElement => {
...
export const renderPackageList = (state: {
    ...
    keyword: string;
}, packageListElement: HTMLElement): void => {
    const source = findSourceByID(state.bundle, state.sourceID);
    if (!source) {

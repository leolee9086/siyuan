export const EDITOR_KEYS = ["config", "fullWidth", "md7", "md8", "md37", "md38",
...
export const FILE_TREE_KEYS = ["selectOpen", "tabLimit", "fileTree", "fileTree2", "fileTree3", "fileTree4", "fileTree5",
...
export const FLASHCARD_KEYS = ["riffCard", "flashcardNewCardLimit", "flashcardNewCardLimitTip", "flashcardReviewCardLimit",
    "flashcardReviewCardLimitTip", "flashcardMark", "flashcardMarkTip", "flashcardList",
...
export const AI_KEYS = ["ai", "apiTimeout", "apiTimeoutTip", "apiMaxTokens", "apiMaxTokensTip", "apiKey",
...
export const EXPORT_KEYS = ["paragraphBeginningSpace", "md4", "export", "export1", "export2", "export5", "export11",
...
export const ACCOUNT_KEYS = ["accountTip", "accountName", "password", "captcha", "forgetPassword", "login", "register",
    "twoFactorCaptcha", "account1", "account2", "account5"
];

export const CLOUD_KEYS = ["cloudStorage", "trafficStat", "sync", "backup", "cdn", "total", "sizeLimit", "cloudBackup",
...
export const PUBLISH_KEYS = ["publishService", "publishServiceTip", "publishServicePort", "publishServicePortTip",
...
export const ABOUT_KEYS = ["autoLaunch", "autoLaunchTip", "about", "about1", "about2", "about3", "about4", "about5", "about6",
...
export const BAZAAR_KEYS = ["bazaar", "theme", "template", "icon", "widget"];

/** 不需要面板过滤的特殊标签类型：图片/集市/账号面板无搜索过滤需求 */
export const SKIP_PANEL_FILTER_TYPES = ["image", "bazaar", "account"];

...
import {sendUnregisterGlobalShortcut} from "../boot/globalEvent/keydown/windowKeyDown";
import {sendGlobalShortcut} from "../boot/globalEvent/keydown/windowKeyDown";
...
<div class="b3-label file-tree config-keymap" id="keymapList">
    <div class="fn__flex config__item">
        ...
        <label class="b3-form__icon fn__block searchByKeyLabel">
            ...
            <input id="searchByKey" style="font-family: var(--b3-font-family-kbd);" data-keymap="" class="b3-form__icon-input b3-text-field fn__block" spellcheck="false" placeholder="${siyuanI18n.keymap}">
        </label>
        <div class="fn__space"></div>

...
export const query = {
    ...
    <div class="fn__flex config-query">
        ...
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.quote} <sup>[1]</sup></div>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.callout} <sup>[1]</sup></div>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.superBlock} <sup>[1]</sup></div>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.list1} <sup>[1]</sup></div>
        </label>
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.listItem} <sup>[1]</sup></div>
        </label>
        <label class="fn__flex">
...
<div class="b3-label">
    ...
    <div class="config-query">
        ...
        <div class="fn__flex label fn__flex-1" style="flex: 2">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.keywordsLimit}</div>
        </div>
    </div>
</div>
<div class="b3-label">
...
<div class="b3-label">
    ...
    <div class="config-query">
        <label class="fn__flex">
            ...
            <span class="fn__space"></span>
            <div>${siyuanI18n.indexAssetPath}</div>
        </label>
    </div>
</div>

...
const registerFileTabsGroup = (tab: SettingTabBuilder) => {
    ...
    group.button({
        id: "fileTreeInternalSettings",
        title: window.siyuan.languages.openInNewTab,
        desc: window.siyuan.languages.openInNewTab,
        label: window.siyuan.languages.edit,
        icon: "iconEdit",
        afterMount: (root) => {
            root.querySelector("#fileTreeInternalSettings")?.addEventListener("click", () => {
                void openFile({

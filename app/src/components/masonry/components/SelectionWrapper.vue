<template>
  <div class="selection-wrapper" :class="wrapperClass" :style="wrapperStyle" ref="wrapperRef" tabindex="0"
    @mousedown="handleMouseDown" @mousemove="handleMouseMove" @mouseup="handleMouseUp" @keydown="handleKeyDown"
    @focus="handleFocus" @blur="handleBlur">
    <!-- 主要内容插槽 -->
    <slot :selection-api="selectionApi" :selection-state="selectionState" :selection-box="selectionBoxState"
      :drag-direction="dragDirection" />

    <!-- 内置选择框 -->
    <SelectionBox :visible="selectionBoxState.visible" :is-selecting="selectionBoxState.isSelecting"
      :selection-box-state="selectionBoxState" :z-index="selectionBoxZIndex" :class="selectionBoxClass"

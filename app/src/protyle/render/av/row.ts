...
import {getAvBodyData, resetAVRowSelect, updateAVRowSelect} from "./virtualScroll/state";
...
export const getRowHTML = async (options: {
    ...
    if (options.type === "gallery") {
        ...
        for (const [fieldsIndex, cell] of galleryRow.values.entries()) {
            ...
            const renderedCell = await renderCell(cell.value, options.rowIndex, kanbanData.showIcon, "gallery");

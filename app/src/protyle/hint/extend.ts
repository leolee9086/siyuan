...
export const hintSlash = (key: string, protyle: IProtyle) => {
    const allList: IHintData[] = [
        templateItem({ key, protyle }),
        widgetItem({ key, protyle }), {
...
> ${Lute.Caret}`,
        html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconCallout"></use></svg><span class="b3-list-item__text">${window.siyuan.languages.callout}</span></div>`,
            ...
            id: "code",
            value: "```",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconCode"></use></svg><span class="b3-list-item__text">${siyuanI18n.code}</span>${getHotkeyOrMarker(getSiyuanConfig().keymap.editor.insert.code.custom, "```" + siyuanI18n.enterKey)}</div>`,
        }, {
            filter: [siyuanI18n.table, "table", "表格", "biaoge", "bg"],
            id: "table",
            value: `| ${Lute.Caret} |  |  |\n| --- | --- | --- |\n|  |  |  |\n|  |  |  |`,
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconTable"></use></svg><span class="b3-list-item__text">${siyuanI18n.table}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.table.custom))}</span></div>`,
        }, {
            ...
            id: "link",
            value: "a",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconLink"></use></svg><span class="b3-list-item__text">${siyuanI18n.link}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.link.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.bold, "bold", "strong", "粗体", "cuti", "ct", "加粗", "jiacu", "jc"],
            id: "bold",
            value: "strong",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconBold"></use></svg><span class="b3-list-item__text">${siyuanI18n.bold}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.bold.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.italic, "italic", "em", "斜体", "xieti", "xt"],
            id: "italic",
            value: "em",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconItalic"></use></svg><span class="b3-list-item__text">${siyuanI18n.italic}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.italic.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.underline, "underline", "下划线", "xiahuaxian", "xhx"],
            id: "underline",
            value: "u",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconUnderline"></use></svg><span class="b3-list-item__text">${siyuanI18n.underline}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.underline.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.strike, "strike", "delete", "删除线", "shanchuxian", "scx"],
            id: "strike",
            value: "s",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconStrike"></use></svg><span class="b3-list-item__text">${siyuanI18n.strike}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.strike.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.mark, "mark", "标记", "biaoji", "bj", "高亮", "gaoliang", "gl"],
            id: "mark",
            value: "mark",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconMark"></use></svg><span class="b3-list-item__text">${siyuanI18n.mark}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.mark.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.sup, "superscript", "上标", "shangbiao", "sb"],
            id: "sup",
            value: "sup",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconSup"></use></svg><span class="b3-list-item__text">${siyuanI18n.sup}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.sup.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.sub, "subscript", "下标", "xiaobiao", "xb"],
            id: "sub",
            value: "sub",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconSub"></use></svg><span class="b3-list-item__text">${siyuanI18n.sub}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.sub.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n["inline-code"], "inline code", "行级代码", "hangjidaima", "hjdm"],
            id: "inlineCode",
            value: "code",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconInlineCode"></use></svg><span class="b3-list-item__text">${siyuanI18n["inline-code"]}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert["inline-code"].custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.kbd, "kbd", "键盘", "jianpan", "jp"],
            id: "kbd",
            value: "kbd",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconKeymap"></use></svg><span class="b3-list-item__text">${siyuanI18n.kbd}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.kbd.custom))}</span></div>`,
        }, {
            filter: [siyuanI18n.tag, "tags", "标签", "biaoqian", "bq"],
            id: "tag",
            value: "tag",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconTags"></use></svg><span class="b3-list-item__text">${siyuanI18n.tag}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert.tag.custom))}</span></div>`,
        }, {
            ...
            id: "inlineMath",
            value: "inline-math",
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconMath"></use></svg><span class="b3-list-item__text">${siyuanI18n["inline-math"]}</span><span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip((getSiyuanConfig().keymap.editor.insert["inline-math"].custom))}</span></div>`,
        }, {
            value: "",
            id: "separator_3",
            html: "separator",
...
<input class="b3-form__upload" type="file" ${protyle.options.upload?.accept ? 'multiple="' + protyle.options.upload.accept + '"' : ""}></div>`,
            ...
            html: `<div class="b3-list-item__first"><svg class="b3-list-item__graphic"><use xlink:href="#iconLanguage"></use></svg><span class="b3-list-item__text">${siyuanI18n.insertIframeURL}</span></div>`,
        }, {

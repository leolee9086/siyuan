...
<div class="b3-label">
    ...
    <div style="color:var(--b3-theme-surface);font-family: cursive;">浼氭辰鐧惧&nbsp;鑷冲叕澶╀笅</div>
    ${window.siyuan.languages.about1} ${"harmony" === window.siyuan.config.system.container ? " 鈥?" + window.siyuan.languages.feedback + " 845765@qq.com" : ""}
</div>
</div>`,
                ...
                while (target && (target !== modelMainElement)) {
                    if (target.id === "authCode") {
                        ...
                        const passwordDialog = new Dialog({
                            title: "馃攽 " + window.siyuan.languages.key,
...
<div class="b3-dialog__action">
    ...
    <button class="b3-button b3-button--text">${window.siyuan.languages.confirm}</button>
                        ...
                        confirmDialog("馃攽 " + window.siyuan.languages.genKey, window.siyuan.languages.initRepoKeyTip, () => {
                        ...
                        confirmDialog("鈿狅笍 " + window.siyuan.languages.resetRepo, window.siyuan.languages.resetRepoTip, () => {
                        ...
                        confirmDialog("鈾伙笍 " + window.siyuan.languages.dataRepoPurge, window.siyuan.languages.dataRepoPurgeConfirm, () => {

...
import {initKeyboardToolbar} from "./keyboardToolbar";
...
const openDockMenu = (app: AppFacade, element: HTMLElement) => {
...
const updateDock = (app: AppFacade, type: MobileSidePanelDockId, element: HTMLElement, openPluginMenu = false) => {
    if (type === "outline") {
...
const initSidePanelTabs = (app: AppFacade, sidePanelElement: HTMLElement) => {
...
export const initFramework = async (app: AppFacade, isStart: boolean): Promise<void> => {
    setInlineStyle();

...
import {setAIEditorDestroy} from "./editorLifecycle.port";
...
// AI 模块装配后向通用 Protyle 销毁流程发布当前实现。
setAIEditorDestroy(destroyAIEditor);

...
import { focusBlock, focusByRange, getEditorRange, focusByWbr, getSelection } from "../protyle/util/selection";
import {
    deleteColumn,
    deleteRow,
    getColIndex,
...
import { hasClosestByClassName, hasClosestByTag, hasClosestByAttribute, hasTopClosestByClassName } from "../protyle/util/hasClosest";

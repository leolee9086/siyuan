...
/** 用途：布局模型最小接口。使用范围：Dock 工厂返回值。解耦评估：通过 imports.ts 获取抽象契约，不依赖具体 Model 类。 */
 ...
 */
export type ModelFactory = (app: App, tab: Tab, editor?: Protyle, data?: unknown) => ILayoutModel | undefined;
 ...
 */
export type ModelConstructor = new (app: App, tab: Tab, editor?: Protyle, data?: unknown) => ILayoutModel;

...
<button class="b3-button b3-button--small fn__block">${siyuanI18n.reset}</button>`;
    ...
    <div class="block__logo block__logo--counter fn__flex-1">${this.type === "global" ? siyuanI18n.globalGraph : siyuanI18n.graphView}<span class="counter fn__none" data-type="node-count"></span></div>

 ...
 */
export function setCurrent(outline: OutlineDomain, nodeElement: HTMLElement) {
    if (!nodeElement) {
        return;
    }
    /**
 ...
 */
export function setCurrentByPreview(outline: OutlineDomain, nodeElement: Element) {
    if (!nodeElement) {
        return;
    }
 ...
 */
export function setCurrentById(outline: OutlineDomain, id: string) {

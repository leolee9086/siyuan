...
import type { FilesEventContext, FilesDomain } from "./eventHandlers.types";
 ...
 * @param files - Files 实例
 */
function handleShiftClick(target: HTMLElement, files: FilesDomain): void {
 ...
 * @returns 是否已处理
 */
function handleCtrlClick(event: MouseEvent, target: HTMLElement, files: FilesDomain): boolean {
 ...
 * @returns 是否已处理
 */
function handleShiftClickSelection(event: MouseEvent, target: HTMLElement, files: FilesDomain): boolean {
...
function handleTitleExpandClick(event: MouseEvent, target: Element, files: FilesDomain, notebookId: string): boolean {
 ...
 * 设置面板焦点
 */
function setFocusIfNeeded(files: FilesDomain): void {
 ...
 */
function onElementClick(event: MouseEvent, files: FilesDomain, app: AppFacade): void {

 ...
 * 更新父节点状态（移动操作后）
 */
const updateParentLiState = (parentLiElement: Element): void => {
    // 如果父节点不是根节点，隐藏展开按钮
...
export const handleSourceElementExists = (sourceElement: HTMLElement): void => {
    ...
    // 源文档是唯一子节点，需要更新父节点状态
    if (parentLiElement) {
        updateParentLiState(parentLiElement);
    }

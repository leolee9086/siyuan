...
export const showDocVersionDiff = (app: AppFacade, firstRef: IDocVersionRef, secondRef: IDocVersionRef) => {
    let [leftRef, rightRef] = orderDocVersionRefs(firstRef, secondRef);
    let editors: ProtyleDomain[] = [];
    ...
    const renderDiff = () => {
        ...
        panels.forEach((panel, index) => {
            ...
            const editor = app.createProtyle(contentElement, {
                blockId: "",

...
import {EventEmitter as g} from "/stage/protyle/js/node/events.mjs";
import {ReadStream as f, WriteStream as p} from "/stage/protyle/js/node/tty.mjs";
var v = "22.14.0"
  , _ = class m extends g {
    env;
    hrtime;
    ...
    constructor(e) {
        ...
        for (let s of [...Object.getOwnPropertyNames(m.prototype), ...Object.getOwnPropertyNames(g.prototype)]) {
            let i = this[s];
            typeof i == "function" && (this[s] = i.bind(this))
        }
    }
    emitWarning(e, s, i) {
        console.warn(`${i ? `[${i}] ` : ""}${s ? `${s}: ` : ""}${e}`)
    }
    emit(...e) {
        return super.emit(...e)
    }
    ...
    #r;
    get stdin() {
        return this.#t ??= new f(0)
    }
    get stdout() {
        return this.#s ??= new p(1)
    }
    get stderr() {
        return this.#r ??= new p(2)
    }
    #e = "/";
    chdir(e) {
        this.#e = e
    ...
    report = {
        ...
        getReport: a("process.report.getReport"),
        writeReport: a("process.report.writeReport")
    };
    finalization = {
        register: a("process.finalization.register"),
        unregister: a("process.finalization.unregister"),
        registerBeforeExit: a("process.finalization.registerBeforeExit")
    };
  ...
  , o = t => globalThis.__env__ || b?.env || (t ? u : globalThis)
  , x = new Proxy(u,{
    get(t, e) {
        return o()[e] ?? u[e]
    },
  ...
  , E = globalThis.queueMicrotask ? (t, ...e) => {
...
function k() {
    ...
    return (c, ...l) => {
        t.push(c.bind(void 0, ...l)),
        t.length === 1 && !e && setTimeout(n)
    }
}
var h = new _({
    env: x,

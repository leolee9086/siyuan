...
// Timestamp: 2025-07-29T14:44:08.749Z
// Based on API definitions from: D:\siyuan\my-siyuan-kernel-SDK\packages\apiDefs
...
class KernelApiClient {
   ...
   * @param {object} data - Request payload
   *   @property {string} avID - 属性视图的 ID
   *   @property {Array<object>} values - 包含多个要更新单元格信息的数组，每个对象包含 blockID, keyID 和 value
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - 返回码，0 表示成功
   *   @property {string} Msg - 返回消息
   ...
   * @throws {Error} If the request fails or the server returns an error.
   */
  async batchSetAttributeViewBlockAttrs(data) {
   ...
   * @param {object} data - Request payload
   *   @property {string} id - 属性视图的 ID
   *   @property {string | undefined} viewID - 可选，当前视图的 ID
   *   @property {string | undefined} query - 可选，查询关键词
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - 返回码，0 表示成功
   *   @property {string} Msg - 返回消息
   *   @property {Array<string>} Data - 当前属性视图中图片 URL 数组
   * @throws {Error} If the request fails or the server returns an error.
   */
  async getCurrentAttrViewImages(data) {
   ...
   * Requires authentication.
   * @param {object} data - Request payload
   *   @property {string} blockID - 属性视图块的 ID
   *   @property {string} avID - 属性视图的 ID
   *   @property {"table" | "board" | "calendar" | "list" | "gallery"} layoutType - 新的布局类型：table, board, calendar, list, gallery
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - 返回码，0 表示成功
   *   @property {string} Msg - 返回消息
   *   @property {object | null} Data - 包含渲染结果的对象
   ...
   * @throws {Error} If the request fails or the server returns an error.
   */
  async changeAttrViewLayout(data) {
   ...
   * @param {object} data - Request payload
   *   @property {string} avID - 属性视图的 ID
   *   @property {string} blockID - 属性视图关联的块 ID
   *   @property {any} group - 分组配置对象，具体结构请参考 Go 源码 `av.ViewGroup`
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - 返回码，0 表示成功
   *   @property {string} Msg - 返回消息
   *   @property {null | undefined} Data - 成功时通常为 null
   ...
   * @param {object} data - Request payload
   *   @property {string} avID - 属性视图的 ID
   *   @property {boolean} isDetached - 是否处理独立的（未附加的）属性视图块
   *   @property {Array<Record<string, string>>} oldNew - 包含旧块 ID 和新块 ID 映射关系的数组，例如：[{'oldID1': 'newID1'}, {'oldID2': 'newID2'}]
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - 返回码，0 表示成功
   *   @property {string} Msg - 返回消息
   *   @property {null | undefined} Data - 成功时通常为 null
   * @throws {Error} If the request fails or the server returns an error.
   */
  async batchReplaceAttributeViewBlocks(data) {
   ...
   * Requires authentication.
   * @param {object} data - Request payload
   *   @property {Array<string>} ids - 要获取 DOM 的块 ID 数组
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - API 调用返回码，0 表示成功
   *   @property {string} Msg - API 调用返回消息
   *   @property {Record<string, string>} Data - 一个记录对象，键为块 ID，值为该块的 DOM 内容
   * @throws {Error} If the request fails or the server returns an error.
   */
  async getBlockDOMs(data) {
   ...
   * Requires authentication.
   * @param {object} data - Request payload
   *   @property {Array<object>} blocks - 包含多个待插入块信息的数组
   * @returns {Promise<object>} The response from the server.
   *   @property {number} Code - API 调用返回码，0 表示成功
   *   @property {string} Msg - API 调用返回消息
   *   @property {Array<object> | null} Data - 成功时返回包含新块 ID 的数组，失败时为 null
